# File: db/managers/resource_share.py
...
# To activate: set view_class = ResourceShareView on your manager subclass,
...
class ResourceShareView(ModelView[ResourceShare]):
    """
    Declarative view for ResourceShare.
    ...
    Add async methods (no leading underscore) for computed fields:
        ...
        async def display_name(self, model: ResourceShare) -> str:
...
class ResourceShareBase(BaseManager[ResourceShare]):
    ...
    def __init__(
        ...
        super().__init__(ResourceShare, dto_class=dto_class or ResourceShareDTO)
